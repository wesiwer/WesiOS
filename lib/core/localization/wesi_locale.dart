...
class WesiLocale {
  ...
  static final Map<String, Map<String, String>> _strings = {
    'ru': {
      ...
      'wesi_forecast_desc': 'Показывает, сколько денег останется через неделю, месяц или год. Приложение проигрывает тысячи вариантов того, как могут сложиться доходы и траты, и показывает не одну цифру, а от худшего расклада до лучшего.',
      'wesi_forecast_purpose': 'Понять, к чему идут деньги, и заранее увидеть месяц, в котором их может не хватить.',
      ...
      'forecast_loading': 'Считаем прогноз…',
      'monte_carlo_simulating': 'Проигрываем варианты будущего…',
      'p50_in_days': 'Скорее всего через {days} дн.',
      'p10_worst': 'Если не повезёт',
      'p90_best': 'Если всё сложится',
      ...
      'p10_p90_range': 'От худшего к лучшему',
      ...
      'forecast_p10_p50_p90': 'Худший, вероятный и лучший расклад',
      'monte_carlo_analysis': 'Тысячи вариантов будущего — от неудачного до удачного',
      'record_income': 'Записать доход или продажу',
      'record_expense': 'Записать расход',
      'loading_treasury': 'Загрузка Wesi Treasury...',
      'cancel': 'Отмена',
      'insert': 'Вставить',
      'article_title_hint': 'Заголовок статьи',
      'article_tags_hint': 'Теги через запятую',
      'link_text': 'Текст ссылки',
      'link_url': 'URL (https:// или wesios://)',
      'link_wesios_hint': 'wesios://article/ID — ссылка на статью',
      'table_rows': 'Строки',
      'table_cols': 'Столбцы',
      'image_url_hint': 'URL изображения',
      'video_url_hint': 'URL видео (MP4, WebM)',
      'article_empty': 'Статья пуста',
      ...
      'monte_carlo_paths': 'проверено {n} вариантов',
      ...
      'day': 'День',
      'engine_install_banner_title': 'Доступны дополнительные движки прогноза',
      'engine_install_banner_hint': 'Prophet и SARIMAX — настоящие библиотеки прогнозирования временных рядов. Устанавливаются по требованию, не занимают место, пока не скачаны.',
      'engine_stage_downloading': 'скачивание',
      'engine_stage_extracting': 'распаковка',
      'engine_download': 'Скачать',
      'engine_retry': 'Повторить',
      'engine_downloading_title': 'Установка движка прогноза',
      'engine_settings_section': 'Модели прогноза',
      'engine_installed': 'Установлен',
      'engine_not_installed': 'Не установлен',
      'engine_install_button': 'Установить',
      'engine_reinstall_button': 'Переустановить',
      'engine_windows_only': 'Доступно только на Windows',
      'engine_needs_github': 'Нужен вход в GitHub: Настройки → Ключи',
      'engine_not_published': 'Сборка ещё не опубликована',
      'engine_download_failed': 'Не удалось скачать — проверьте связь',
    ...
    'en': {
      ...
      'wesi_forecast_title': 'Wesi Treasury Forecast',
      'wesi_forecast_desc': 'Shows how much money is left in a week, a month or a year. The app plays out thousands of ways income and spending could go, and shows the range — from the worst case to the best.',
      'wesi_forecast_purpose': 'See where the money is heading, and spot the month it might run out before it does.',
      ...
      'trend': 'Trend',
      'heatmap': 'Heatmap',
      'forecast_loading': 'Working out the forecast…',
      'monte_carlo_simulating': 'Playing out possible futures…',
      'p50_in_days': 'Most likely in {days} days',
      'p10_worst': 'If things go badly',
      'p90_best': 'If things go well',
      ...
      'forecast_p10_p50_p90': 'Worst, likely and best case',
      'monte_carlo_analysis': 'Thousands of possible futures, from bad to good',
      'record_income': 'Record a new income or sale',
      'record_expense': 'Record a new expense',
      'loading_treasury': 'Loading Wesi Treasury...',
      'cancel': 'Cancel',
      'insert': 'Insert',
      'article_title_hint': 'Article title',
      'article_tags_hint': 'Comma-separated tags',
      'link_text': 'Link text',
      'link_url': 'URL (https:// or wesios://)',
      'link_wesios_hint': 'wesios://article/ID — link to article',
      'table_rows': 'Rows',
      'table_cols': 'Columns',
      'image_url_hint': 'Image URL',
      'video_url_hint': 'Video URL (MP4, WebM)',
      'article_empty': 'Article is empty',
      ...
      'monte_carlo_paths': '{n} futures checked',
      ...
      'day': 'Day',
      'engine_install_banner_title': 'Additional forecast engines available',
      'engine_install_banner_hint': 'Prophet and SARIMAX are real time-series forecasting libraries. Installed on demand — no footprint until you download them.',
      'engine_stage_downloading': 'downloading',
      'engine_stage_extracting': 'extracting',
      'engine_download': 'Download',
      'engine_retry': 'Retry',
      'engine_downloading_title': 'Installing forecast engine',
      'engine_settings_section': 'Forecast Models',
      'engine_installed': 'Installed',
      'engine_not_installed': 'Not installed',
      'engine_install_button': 'Install',
      'engine_reinstall_button': 'Reinstall',
      'engine_windows_only': 'Windows only',
      'engine_needs_github': 'GitHub sign-in required: Settings → Keys',
      'engine_not_published': 'Not published yet',
      'engine_download_failed': 'Download failed — check the connection',
