...
class WesiLocale {
  ...
  static final Map<String, Map<String, String>> _strings = {
    'ru': {
      ...
      'cash_gap_risk': 'Риск кассового разрыва',
      'cash_gap_risk_detail': 'вероятность ухода в минус выше 5% уже через {days} дн. (≈{date})',
      'what_if': 'Что если?',
      'what_if_hint': 'Смоделируйте гипотетическое событие или изменение доходов/расходов — реальные данные не меняются',
      'what_if_add_event': 'Добавить разовое событие',
      'what_if_event_title': 'Название события',
      'what_if_event_date': 'Дата события',
      'what_if_income_adjust': 'Доходы',
      'what_if_expense_adjust': 'Расходы',
      'what_if_apply': 'Применить',
      'what_if_reset': 'Сбросить',
    ...
    'en': {
      ...
      'cash_gap_risk': 'Cash Gap Risk',
      'cash_gap_risk_detail': 'probability of going negative exceeds 5% within {days}d (≈{date})',
      'what_if': 'What if?',
      'what_if_hint': 'Model a hypothetical event or income/expense change — real data stays untouched',
      'what_if_add_event': 'Add a one-off event',
      'what_if_event_title': 'Event title',
      'what_if_event_date': 'Event date',
      'what_if_income_adjust': 'Income',
      'what_if_expense_adjust': 'Expenses',
      'what_if_apply': 'Apply',
      'what_if_reset': 'Reset',
