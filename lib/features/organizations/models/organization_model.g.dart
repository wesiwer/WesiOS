...
class OrganizationModelAdapter extends TypeAdapter<OrganizationModel> {
  ...
  OrganizationModel read(BinaryReader reader) {
    ...
    return OrganizationModel(
      ...
      isRoot: fields[3] as bool? ?? false,
      baseCurrency: fields[4] as String? ?? 'RUB',
      status: fields[5] as OrganizationStatus? ?? OrganizationStatus.active,
      createdAt: fields[6] as DateTime? ?? DateTime.fromMillisecondsSinceEpoch(0),
      updatedAt: fields[7] as DateTime? ?? DateTime.fromMillisecondsSinceEpoch(0),
      createdBy: fields[8] as String? ?? 'migration',
  ...
  void write(BinaryWriter writer, OrganizationModel obj) {
    writer
      ...
      ..writeByte(2)..write(obj.parentId)
      ..writeByte(3)..write(obj.isRoot)
      ..writeByte(4)..write(obj.baseCurrency)
      ..writeByte(5)..write(obj.status)
      ..writeByte(6)..write(obj.createdAt)
      ..writeByte(7)..write(obj.updatedAt)
      ..writeByte(8)..write(obj.createdBy)
      ..writeByte(9)..write(obj.code)
      ..writeByte(10)..write(obj.description)
      ..writeByte(11)..write(obj.colorValue)
