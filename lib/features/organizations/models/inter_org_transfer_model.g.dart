...
class InterOrgTransferModelAdapter extends TypeAdapter<InterOrgTransferModel> {
  ...
  InterOrgTransferModel read(BinaryReader reader) {
    ...
    return InterOrgTransferModel(
      ...
      amountInFromOrgBase: fields[7] as double,
      amountInToOrgBase: fields[8] as double,
      type: fields[9] as InterOrgTransferType,
  ...
  void write(BinaryWriter writer, InterOrgTransferModel obj) {
    writer
      ...
      ..write(obj.id)
      ..writeByte(1)
      ..write(obj.fromOrganizationId)
      ..writeByte(2)
      ..write(obj.toOrganizationId)
      ..writeByte(3)
      ...
      ..write(obj.currency)
      ..writeByte(7)
      ..write(obj.amountInFromOrgBase)
      ..writeByte(8)
      ..write(obj.amountInToOrgBase)
      ..writeByte(9)
      ..write(obj.type)
      ..writeByte(10)
      ..write(obj.note)
      ...
      ..write(obj.createdAt)
      ..writeByte(14)
      ..write(obj.linkedDebitTransactionId)
      ..writeByte(15)
      ..write(obj.linkedCreditTransactionId)
      ..writeByte(16)
      ..write(obj.cancelled)
      ..writeByte(17)
  ...
  bool operator ==(Object other) =>
      ...
      other is InterOrgTransferModelAdapter &&
...
class InterOrgTransferTypeAdapter extends TypeAdapter<InterOrgTransferType> {
  ...
  InterOrgTransferType read(BinaryReader reader) {
    switch (reader.readByte()) {
      case 0:
        return InterOrgTransferType.investment;
      case 1:
        return InterOrgTransferType.profitShare;
      case 2:
        return InterOrgTransferType.funding;
      case 3:
        return InterOrgTransferType.internalTransfer;
      case 4:
        return InterOrgTransferType.other;
      default:
        return InterOrgTransferType.investment;
    }
  }
  ...
  void write(BinaryWriter writer, InterOrgTransferType obj) {
    switch (obj) {
      case InterOrgTransferType.investment:
        writer.writeByte(0);
        break;
      case InterOrgTransferType.profitShare:
        writer.writeByte(1);
        break;
      case InterOrgTransferType.funding:
        writer.writeByte(2);
        break;
      case InterOrgTransferType.internalTransfer:
        writer.writeByte(3);
        break;
      case InterOrgTransferType.other:
        writer.writeByte(4);
        break;
    }
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is InterOrgTransferTypeAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
