...
void main() async {
  ...
  // Вход, который просили не запоминать, до этой строки дожил только
  // потому, что программу закрыли. Теперь его пора забыть — до того, как
  // хоть один экран успеет спросить, кто вошёл.
