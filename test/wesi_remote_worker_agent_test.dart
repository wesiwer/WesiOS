...
void main() {
  ...
  test('desktop agent executes assignment once and returns durable result',
      () async {
    ...
    final client = MockClient((request) async {
      ...
      if (request.url.path == '/api/wesi/ai/workers/message') {
        ...
        final payload =
            jsonDecode(outer['payloadJson'] as String) as Map<String, dynamic>;
  ...
  test('started receipt after restart blocks automatic duplicate execution',
      () async {
    final assignment = _assignment(now);
